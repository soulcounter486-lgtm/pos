    ...
    <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
      <div className="bg-white rounded-xl shadow-2xl p-8 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">{t('common.kitchen')} {t('common.display')}</h1>
          <p className="text-gray-600">{t('common.order')} {t('common.settings')}</p>
        </div>
        <div className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">{t('common.user_id')}</label>
            <input
              type="text"
              value={username}
          ...
          <div className="text-center text-sm text-gray-500 mt-4">
            {t('common.demo_accounts')}: bep / 1324
          </div>
        </div>
      </div>
    </div>
